...
import { getUser, loginUser, loginUserToReviews } from "../../redux/actions/userActions";
...
class LoginToView extends React.Component {
  constructor() {
    super();
    this.state = {
      email: "",
  ...
  handlesubmit = (event) => {
    ...
    this.props.loginUserToReviews(data, history)
...
export default connect(mapStateToProps, mapActionsToProps)(LoginToView);
