          ...
          <div className="card border-0" >
              <div className="card-body">
                ...
                Double or Twin Room - Max people: 2 <br/>
                 ...
                 <div className="props">
                <a  className="btn btn-outline-success breakfast" ><i className="fa fa-spoon"></i></a>
                <a className="btn btn-success wifi"><i className="fa fa-wifi fa-1x"></i></a>
                </div>
                <p className="card-text locate"><i className="fas fa-map-marker-alt fa-1x logo"></i> Eko hotels Allaba funke Lagos state Nigeria</p>
              </div>
            </div>
      </div>
      <div className="col-md-3">
          <div className="card border-0">
              <div className="card-body">
                ...
                <a href="#" className="card-link btn btn-sm btn-danger cheker">Check this out</a>
              </div>
            </div>
      </div>
    </div>
